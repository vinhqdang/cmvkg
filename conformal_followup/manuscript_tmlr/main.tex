...
benchmarks, two backbones and a mitigation decoder. Four findings organise the paper.
First, the correctness \emph{score} matters more than the procedure: a detection-grounded
score improves certified coverage over model-internal uncertainty by $10.8$--$32.1$ points,
