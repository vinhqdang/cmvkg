...
% ── Track changes highlighter (Revision 2) ──────────────────────────────────────
% [TOGGLE SWITCH]
% To highlight all Revision 2 additions in blue, keep the following line active:
\newcommand{\revised}[1]{{\color{blue}#1}}
% To deactivate highlighting and render all revised text as normal black text
% (e.g., for camera-ready submission or final printing), uncomment the line below:
