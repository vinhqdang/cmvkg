...
\begin{itemize}
    ...
    \item We demonstrate through extensive experiments on standard benchmarks (POPE, CHAIR, MMHalBench) that CMVKG-Guard achieves highly competitive performance, reducing object hallucinations by 84\% and achieving >90\% accuracy on the POPE benchmark. \revisiontwo{We additionally provide detailed sensitivity, robustness, failure case, and Layer 3 independent validation analyses to support scientific rigour.}
\end{itemize}
