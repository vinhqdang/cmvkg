...
We utilize LLaVA-1.5 (7B) as the backbone VLM. The DH-MMKG is constructed using YOLO-World for open-vocabulary detection and Wikidata as the external knowledge source. All experiments were conducted on a single NVIDIA A100 (80GB) GPU. The confidence calibration parameters are initialized with $\mu=0.6$ and $\sigma=0.2$.
